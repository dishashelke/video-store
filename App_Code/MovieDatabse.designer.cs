...
[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="lab6Database")]
public partial class DataClassesDataContext : System.Data.Linq.DataContext
{
  ...
  partial void DeleteRole(Role instance);
	...
	public DataClassesDataContext() : 
			base(global::System.Configuration.ConfigurationManager.ConnectionStrings["lab6DatabaseConnectionString"].ConnectionString, mappingSource)
	{
		OnCreated();
	}
...
public partial class Movy : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<Performer> _Performers;
	...
	{
		this._MovieGenres = new EntitySet<MovieGenre>(new Action<MovieGenre>(this.attach_MovieGenres), new Action<MovieGenre>(this.detach_MovieGenres));
		this._Performers = new EntitySet<Performer>(new Action<Performer>(this.attach_Performers), new Action<Performer>(this.detach_Performers));
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Movy_Performer", Storage="_Performers", ThisKey="movieId", OtherKey="movieId")]
	public EntitySet<Performer> Performers
	{
		get
		{
		...
		set
		{
			this._Performers.Assign(value);
		}
	}
	
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PersonRole_Movy", Storage="_PersonRole", ThisKey="director", OtherKey="personRoleId", IsForeignKey=true)]
		...
		set
		{
						...
						|| (this._PersonRole.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((value != null))
				{
					...
					this._director = value.personRoleId;
				}
				else
				{
	...
	private void attach_Performers(Performer entity)
	{
		this.SendPropertyChanging();
		entity.Movy = this;
	}
	
	private void detach_Performers(Performer entity)
	{
		this.SendPropertyChanging();
		entity.Movy = null;
	}
...
public partial class Person : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_gender", DbType="NChar(8) NOT NULL", CanBeNull=false)]
	...
	[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_nationality", DbType="NChar(20) NOT NULL", CanBeNull=false)]
...
public partial class Performer : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_personRoleId", DbType="Int NOT NULL", IsPrimaryKey=true)]
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Movy_Performer", Storage="_Movy", ThisKey="movieId", OtherKey="movieId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
	public Movy Movy
	{
		get
		{
		...
		set
		{
						...
						|| (this._Movy.HasLoadedOrAssignedValue == false)))
			{
				...
				{
					this._Movy.Entity = null;
					previousValue.Performers.Remove(this);
				}
				this._Movy.Entity = value;
				if ((value != null))
				{
					value.Performers.Add(this);
					this._movieId = value.movieId;
				}
				else
				{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PersonRole_Performer", Storage="_PersonRole", ThisKey="personRoleId", OtherKey="personRoleId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
	public PersonRole PersonRole
	{
		get
		{
		...
		set
		{
						...
						|| (this._PersonRole.HasLoadedOrAssignedValue == false)))
			{
				...
				{
					value.Performers.Add(this);
					this._personRoleId = value.personRoleId;
				}
				else
				{
					this._personRoleId = default(int);
				}
				this.SendPropertyChanged("PersonRole");
			}
		}
...
[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.PersonRole")]
public partial class PersonRole : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PersonRole_Movy", Storage="_Movies", ThisKey="personRoleId", OtherKey="director")]
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PersonRole_Performer", Storage="_Performers", ThisKey="personRoleId", OtherKey="personRoleId")]
	public EntitySet<Performer> Performers
	{
		get
		{
